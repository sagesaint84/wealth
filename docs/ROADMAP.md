...
### Phase 10.5B-4.4 — 개인지방소득세 비교산출세액

상태: 진행 중

B-4.3 금융소득 기납부 원천징수세액은 PR #32 merge commit `4281a31`로 완료되었습니다.

현재 increment:

- 지방세법 제91조에 따라 개인지방소득세 과세표준을 소득세 과세표준과 연결
- 지방세법 제92조 제1항의 개인지방소득세 표준세율 0.6%~4.5% 적용
- 지방세법 제93조 제2항에 따라 금융소득 종합과세기준금액 초과 여부별 A/B 비교산출세액 계산
- 기존 국세 Article 62 결과에 단순히 10%를 곱하지 않고 명시 입력 금융소득 category로 지방세 A/B식을 독립 계산
- 지방세법 제92조 제2항의 지방자치단체 조례에 따른 표준세율 가감은 납세지와 조례 확인 없이 자동 추정하지 않음
- 지방 세액공제·감면, 배당세액공제, 특별징수 기납부세액, 가산세 및 최종 납부·환급세액은 아직 계산하지 않음

## 2. 다음 단계

B-4.4 비교산출세액 완료 후에는 지방 세액공제·감면과 배당세액공제, 특별징수 기납부세액을 공식 자료와 신고서 구조에 따라 각각 후속 increment로 분리합니다. 그 다음 외국납부세액공제를 별도 단계로 진행합니다. 다른 소득의 기납부세액, 중간예납세액, 가산세·추가납부세액 및 모든 공제까지 포함한 최종 납부·환급세액 계산은 계속 별도 범위로 유지합니다.
...
- 지방 세액공제·특별징수 기납부세액·외국납부세액공제 등은 각각 공식 근거 검증 후 별도 increment로 진행
